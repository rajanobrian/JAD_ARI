...
const JOBS = [
  {no:1,  job:"Laporan & Analisa Stresstesting PM Aug-26",                                                  cat:"Operasional",         cc:"cat-op", pics:["BAI"],       prio:"Q1", pl:"I·U",  st:"done", wl:4},
  {no:2,  job:"Laporan & Analisa Stresstesting PUVA Aug-26",                                                cat:"Operasional",         cc:"cat-op", pics:["RFA","SSO"],       prio:"Q1", pl:"I·U",  st:"done", wl:3},
  {no:3,  job:"Laporan dan Analisa Perhitungan KCCP PUVA Aug-26",                                             cat:"Operasional",         cc:"cat-op", pics:["RFA"],       prio:"Q1", pl:"I·U",  st:"done", wl:4},
  ...
  {no:27, job:"Asessment IM dan Stresstest PUVA (volatilitas nilai hasil kalkulasi) ke Razor",           cat:"Adhoc",     cc:"cat-ad", pics:["RFA"], prio:"Q1", pl:"I·U", st:"on",   wl:4},
  ...
  {no:35, job:"Persiapan Audit SPI : audit KPI & SMKI ",           cat:"Adhoc",     cc:"cat-ad", pics:["NDI","BAI"], prio:"Q1", pl:"I·U", st:"on",   wl:3},  
  ...
  {no:37, job:"Trading Limit Troubleshooting Calculation on Razor PM",           cat:"Operasional",     cc:"cat-op", pics:["BAI"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:38, job:"KPI Officer - Update pemenuhan KPI Unit - bulanan",           cat:"Operasional",     cc:"cat-op", pics:["NDI"], prio:"Q1", pl:"I·U", st:"done",   wl:4}, 
  {no:39, job:"Risk Officer - Penyesuaian UAM dan Daftar User Access System (Razor, ARMS, dll)",           cat:"Operasional",     cc:"cat-op", pics:["BAI"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:40, job:"Implementasi dan Pemanfaatan GitLab KPEI (on Sept 26)",           cat:"Adhoc",     cc:"cat-ad", pics:["SSO"], prio:"Q3", pl:"NI·U", st:"on",   wl:4},
  {no:41, job:"Monthly data Fulfillment for Radirkom Aug-26 (Exp, Margin Call, KCCP)",           cat:"Operasional",     cc:"cat-op", pics:["RFA"], prio:"Q1", pl:"I·U", st:"done",   wl:2},
  {no:42, job:"Quarterly data Fulfillment for PQD-PFMI Q2-26",           cat:"Operasional",     cc:"cat-op", pics:["RFA","SSO"], prio:"Q2", pl:"I·NU", st:"done",   wl:3},
  {no:43, job:"Operational Issue - Troubleshooting BBRI missing data",           cat:"Operasional",     cc:"cat-op", pics:["BAI"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:44, job:"Asessment KCCP - Client Level Razor-Cguards (PUVA)",           cat:"Support Project",     cc:"cat-sp", pics:["RFA"], prio:"Q2", pl:"I·NU", st:"done",   wl:3},
  {no:45, job:"Support Industrial Test Calon Anggota CCP (OCBC & JTrust)",           cat:"Adhoc",     cc:"cat-ad", pics:["RFA"], prio:"Q1", pl:"I·U", st:"done",   wl:3},
  {no:46, job:"BCP Officer - Pengecekan Alternater Site DRC dan Aplikasi Unit ARP",           cat:"Adhoc",     cc:"cat-ad", pics:["RFA"], prio:"Q2", pl:"I·NU", st:"done",   wl:3},
  {no:47, job:"Design Study - LSEG (Marginining Methodology)",           cat:"Support Project",     cc:"cat-sp", pics:["BAI","SSO"], prio:"Q1", pl:"I·U", st:"done",   wl:5},
  {no:48, job:"Materi Calculation Method and Collateral - for Management & FTSE",           cat:"Adhoc",     cc:"cat-ad", pics:["NDI","SSO"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:49, job:"Materi Haircut Flow & Calculation - For Blackrock",           cat:"Adhoc",     cc:"cat-ad", pics:["NDI","SSO"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:50, job:"Kalkulasi Persentase Kecukupan Sumber Keuangan CCP dan Keandalan Stress Testing - KPI Unggulan",           cat:"Operasional",     cc:"cat-op", pics:["NDI"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:51, job:"Review Peraturan BEI Nomor I-E tentang Kewajiban Penyampaian Informasi",           cat:"Adhoc",     cc:"cat-ad", pics:["NDI"], prio:"Q3", pl:"I·U", st:"done",   wl:2},
  {no:52, job:"Materi Publikasi Haircut Website KPEI",           cat:"Adhoc",     cc:"cat-ad", pics:["NDI","SSO"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:53, job:"Materi Penyampaian Risk Management for Demutualisasi SRO",           cat:"Adhoc",     cc:"cat-ad", pics:["NDI","SSO"], prio:"Q1", pl:"I·U", st:"done",   wl:4},
  {no:54, job:"Simulasi Rebalancing MSCI - Aug-26",           cat:"Adhoc",     cc:"cat-ad", pics:["NDI","SSO","RFA","BAI"], prio:"Q1", pl:"I·U", st:"done",   wl:5},
  {no:55, job:"Update POS dan Risk Register atas penyesuaian operasional HC KPEI",           cat:"Adhoc",     cc:"cat-ad", pics:["BAI"], prio:"Q1", pl:"I·U", st:"on",   wl:3},
  {no:56, job:"Koordinasi Aktivasi Scheduler penarikan data price intraday dari PDC",           cat:"Adhoc",     cc:"cat-ad", pics:["BAI"], prio:"Q2", pl:"I·NU", st:"on",   wl:3},
  {no:57, job:"Pemenuhan data Statistik PUVA ke RPB periode Juli-26 (H+3 Awal Bulan)",           cat:"Adhoc",     cc:"cat-ad", pics:["RFA"], prio:"Q2", pl:"I·NU", st:"done",   wl:3},
];
