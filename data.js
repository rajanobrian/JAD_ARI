...
const JOBS = [
  ...
  {no:37, job:"Pengisian & Review Public Quantitative Disclosure",           cat:"Legal Review",     cc:"cat-np", pics:["RFA"], prio:"Q1", pl:"I·U", st:"on",   wl:5},
  {no:38, job:"Materi dan Persiapan Checklist Onsite Visit Razor",           cat:"Adhoc",     cc:"cat-np", pics:["BAI"], prio:"Q1", pl:"I·U", st:"on",   wl:4},
  {no:39, job:"Review SOP dan Kebijakan OCBC-PUVA",           cat:"Adhoc",     cc:"cat-np", pics:["RFA"], prio:"Q1", pl:"I·U", st:"on",   wl:3},
  {no:40, job:"Permohonan Assessment Pengelolaan jaminan dan Penjaminan Transaksi Margin PEI",           cat:"Support Project",     cc:"cat-sp", pics:["BAI","SSO"], prio:"Q2", pl:"I·NU", st:"on",   wl:4},
  {no:41, job:"Materi PSKR - Opsi strateri Risk Management System (1)Razor, (2)Razor-LSEG, (3)LSEG",           cat:"Support Project",     cc:"cat-sp", pics:["BAI"], prio:"Q2", pl:"I·NU", st:"on",   wl:4},
  {no:42, job:"Asessment IM dan Stresstest PUVA (volatilitas nilai hasil kalkulasi) ke Razor",           cat:"Adhoc",     cc:"cat-np", pics:["RFA"], prio:"Q2", pl:"I·NU", st:"on",   wl:4},
];
